...
train_dataset_path = "/data/cvx-coder/dpo/train/train.jsonl"
eval_dataset_path = "/data/cvx-coder/dpo/eval/eval.jsonl"
...
# model = PeftModel.from_pretrained(model, "/data/cvx-coder/outputmodels/checkpoint-60")
...
cross_entr_loss_dataset = "/data/cvx-coder/test_merge.jsonl"

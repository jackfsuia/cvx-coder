...
python fine_tune.py \
    ...
    --data_path "/data/Phi-3-mini-4k-instruct/merge_train.jsonl" \
    --eval_data_path "/data/Phi-3-mini-4k-instruct/test_merge.jsonl" \
    ...
    # --resume_from_checkpoint "/data/Phi-3-mini-4k-instruct/outputmodels2/checkpoint-69" \
